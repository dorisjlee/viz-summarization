...
\caption{Example illustrating how the frontier greedy algorithm incrementally build up the solution by selecting the maximal-edge utility node from the frontier at every step.\agp{explain example}}
\end{figure}
\begin{algorithm}
  \begin{algorithmic}[1]
