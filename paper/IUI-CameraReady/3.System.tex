...
to the utility of a node/visualization is depicted as the number within the node.}
On the right, the newly added node results in an updated frontier and the node 
