...
may begin by generating a 7-visualization dashboard.}\agp{I think the narrative here is a bit missing. What do they learn overall from this dashboard? I think we should say that there's something to be gained from the overall dashboard which leads to interesting insights and spurs the analyst to then drill-down further, centered
on something else..}
...
\system allows users \change{to perform additional 
...
the analyst learns that for \change{drivers} 
