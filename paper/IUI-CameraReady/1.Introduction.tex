...
\change{To prevent analysts from fall prey to such drill-down fallacies---consisting of misleadingly ``surprising''
...
in visual analytics, including Simpson's Paradox~\cite{Guo2017,Armstrong2014}, Multiple Comparison's Problem~\cite{Zgraggen2018CHI}, Selection Bias~\cite{Gotz2016},
