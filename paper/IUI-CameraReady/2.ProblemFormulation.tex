...
and visualize
\change{their measures of interest for each data subset---in this case the percentage of votes for each candidate}.
...
However, this deviation is a result of \fem not being the {\em proper} parent or reference for \blkfem. Here, a different parent, \blk,
is the proper reference of \blkfem
because it is one that exhibits the least deviation relative
to \blkfem.
In this case, we find
that the \blkfem visualization
