...
parent, if present\footnote{If multiple informative parents, $V_i^{*, \theta}$, are present for a given visualization, $V_i$, then $U(V_i)$ is defined in terms of the most informative parent present.}.
