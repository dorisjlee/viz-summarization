...
\newcommand{\shortsystem}{\textsc{VP}\xspace}%shorthand for storyboard
...
\acmConference[IUI 2019] {IUI Conference on Intelligent User Interfaces Proceedings}{March 17--20, 2019}{Los Angeles, USA}
