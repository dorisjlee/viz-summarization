...
\dor{Changed the example by using Vi as a two-filter visualization (instead of three for clarity). Removed illustration figure, since simplified example should be sufficient (also relatives makes edges in diagram too complex and hard to trace back).}
\begin{enumerate}
...
summarization guarantee(s)\dor{not sure if this makes sense here} for the users and
