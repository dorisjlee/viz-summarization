...
\begin{tikzpicture}[scale=0.75, every node/.style={scale=0.75}]
  ...
  (21) -- (31) (24) -- (32);
\end{tikzpicture}
\caption{Hierarchy of data subsets for a dataset with three binary attributes {\tt \{P, Q, R\}}. The data subsets (called cells in datacubes) that belong to the same attribute combination (cuboid) are highlighted with same color.\hazem{Perhaps we can show another figure here (1a and 1b) of the lattice with the attributes only (no values) and same color scheme.}}
\label{fig:lattice}
\end{figure}
